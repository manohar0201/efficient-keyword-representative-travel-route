    ...
    <div id="main">
      ...
      <div class="box"> <a name="SampleTags"></a>
          ...
          <center>
            ...
            <label style="font-size: 20px;margin-left:30px;color:  darkorange">Search  place :</label> <br>
                
            <input type="text" class="textbox"  style="height: 32px; width:270px; " name="search"required="" style="margin-left: 45px;" placeholder="key search"/>
           </center><br>
