                    ...
                    <tr>
                        <%
                            ...
                            try {
                                ...
                                String  keysearch=(String)session.getAttribute("uskey");
                                con = Dbconnection.getConnection();
                                st = con.createStatement();
                                
                                rs = st.executeQuery("select * from addplace where (placename='"+keysearch+"' or location='"+keysearch+"') or  (season='"+keysearch+"')");
                                while (rs.next()) {
