    ...
    <div id="main">
      ...
      <div class="box"> <a name="SampleTags"></a>
          ...
          <center>
              <br></br>
              <div>
                  <form action="search2a.jsp " method="post">
                 <center>
               
                     <center><u><h1 style="margin-left: 50px;font-size: 40px;font-family: Colonna MT;color:  brown" >Travel root Places </h1></center></u><br></br>
  
                
            <input type="text" class="textbox"  style="height: 32px; width:270px; " name="from"required="" style="margin-left: 45px;" placeholder="from"/>
           <input type="text" class="textbox"  style="height: 32px; width:270px; " name="to"required="" style="margin-left: 45px;" placeholder="TO"/>
