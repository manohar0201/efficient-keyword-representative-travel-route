    ...
    <div id="main">
      ...
      <div class="box"> <a name="SampleTags"></a>
          ...
          <center>
               ...
               <center><u><h1 style="margin-left: 50px;font-size: 40px;font-family: Colonna MT;color:  brown" >View All Places </h1></center></u>
            ...
            %>
                           ...
                           <td style="color:black;font-size: 20px"><%=rs.getString("category")%></td>  
                            <td style="color:black;font-size: 20px"><%=rs.getString("location")%></td>
                             ...
                             <td style="color:black;font-size: 15px"><a href="viewmap.jsp?<%=rs.getString("id")%>" style="color:  crimson">view</a></td>
