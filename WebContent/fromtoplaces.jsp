  ...
  <div id="content">
    ...
    <div id="main">
      ...
      <div class="box"> <a name="SampleTags"></a>
          ...
          <center>
             <center><u><h1 style="margin-left: 50px;font-size: 40px;font-family: Colonna MT;color:  brown" >View From TO Visiting Places </h1></center></u>
              ...
              <div style="width:1020px;height:290px;overflow: auto">
                  <table border="1" style="margin-left: 1px;text-align: center;width: 300px;height: 300px;">
                    <tr >
                        ...
                        <th style="color:blueviolet;font-size: 20px">Place1</th>
                        <th style="color:blueviolet;font-size: 20px">Place2</th>
                        <th style="color:blueviolet;font-size: 20px">Place3</th>
                       
                        
                         
                        <th style="color:blueviolet;font-size: 20px">Place4</th>
                        <th style="color:blueviolet;font-size: 20px">Place5</th>
                    ...
                    <tr>
                        <%
                            ...
                            try {
                                ...
                                rs = st.executeQuery("select * from addplaces");
                                while (rs.next()) {
                                     
            %>
                            <td style="color:black;font-size: 20px"><%=rs.getString("fromss")%></td>
                            <td style="color:black;font-size: 20px"><%=rs.getString("tos")%></td>  
                           <td style="color:black;font-size: 20px"><%=rs.getString("place1")%></td>  
                            <td style="color:black;font-size: 20px"><%=rs.getString("place2")%></td>
                          
                            <td style="color:black;font-size: 20px"><%=rs.getString("place3")%></td>
                            <td style="color:black;font-size: 20px"><%=rs.getString("place4")%></td>
                             <td style="color:black;font-size: 20px"><%=rs.getString("place5")%></td> 
