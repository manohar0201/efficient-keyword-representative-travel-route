      ...
      <div class="box"> <a name="SampleTags"></a>
          ...
          <center>
                    ...
                    <tr>
                        <%
                            ...
                            try {
                                ...
                                rs = st.executeQuery("SELECT username,froms,too,COUNT(*) FROM searchfroom GROUP BY username order by username desc");
                                while (rs.next()) {
            ...
            %>
                           ...
                           <td style="color:black;font-size: 20px"><%=rs.getString("too")%></td>  
