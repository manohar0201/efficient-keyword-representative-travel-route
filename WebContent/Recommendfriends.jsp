    ...
    <div id="main">
      ...
      <div class="box"> <a name="SampleTags"></a>
          ...
          <center>
             ...
             <center><u><h1 style="margin-left: 50px;font-size: 40px;font-family: Colonna MT;color:  brown" >View Friend Request  and Respond Details </h1></center></u>
              ...
              <div style="width:1020px;height:290px;overflow: auto">
                  <table border="1" style="margin-left: 1px;text-align: center;width: 300px;height: 300px;">
                    <tr >
                        ...
                        <th style="color:blueviolet;font-size: 20px">Request User</th>
                    ...
                    <tr>
                        <%
                            ...
                            try {
                                ...
                                rs = st.executeQuery("select * from frrequest");
                                while (rs.next()) {
