            ...
            <div id="content">
                ...
                <div id="main">
                    ...
                    <div class="box"> <a name="SampleTags"></a>
                        ...
                        <center>
                            <center><u><h1 style="margin-left: 50px;font-size: 40px;font-family: Colonna MT;color:  brown" >User Registration Details </h1></center></u>


                            <div style="width:1020px;height:290px;overflow: auto">
                                <table border="1" style="margin-left: 1px;text-align: center;width: 290px;height: 300px;">
                                    <tr >
                                        <th style="color:blueviolet;font-size: 20px">Profile</th>
                                        <th style="color:blueviolet;font-size: 20px">Username</th>
                                        <th style="color:blueviolet;font-size: 20px">User id</th>
                                        <th style="color:blueviolet;font-size: 20px">User Mail_id</th>
                                        <th style="color:blueviolet;font-size: 20px">Mobile</th>



                                        <th style="color:blueviolet;font-size: 20px">Location</th>
                                        <th style="color:blueviolet;font-size: 20px">Gender</th>
                                        <th style="color:blueviolet;font-size: 20px">Dob</th>
                                    ...
                                    <tr>
                                        <%
                                            ...
                                            try {
                                                ...
                                                rs = st.executeQuery("select * from userregs");
                                                while (rs.next()) {

                                        %>
                                        <td><img src="viewimag.jsp?id=<%=rs.getString("id")%>" width="70px" height="50px"/></td>
                                        <td style="color:black;font-size: 20px"><%=rs.getString("usernmae")%></td>
                                        <td style="color:black;font-size: 20px"><%=rs.getString("useerid")%></td>  
                                        <td style="color:black;font-size: 20px"><%=rs.getString("mailids")%></td>  
                                        <td style="color:black;font-size: 20px"><%=rs.getString("phone")%></td>

                                        <td style="color:black;font-size: 20px"><%=rs.getString("location")%></td>
                                        <td style="color:brown;font-size: 20px"><%=rs.getString("gender")%></td>
                                        <td style="color:black;font-size: 20px"><%=rs.getString("dob")%></td> 
                                        <td style="color:black;font-size: 20px"><%=rs.getString("request")%></td> 
                                        <td style="color:black;font-size: 15px"><a href="activates.jsp?<%=rs.getString("id")%>" style="color:  crimson">Approval</a></td>
