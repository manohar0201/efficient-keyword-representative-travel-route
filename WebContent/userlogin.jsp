...
<body>
    <%
        ...
        <script>alert('Username and Password wrong ');</script>  
        <%}
        %>
        <%
            if (request.getParameter("uumsggg") != null) {%>
        <script>alert('Your not Verified  ');</script>  
        <%}
        %>
    <style>
        .textbox { 
          ...
          <center>
              ...
              <div>
                  <form action="caction.jsp" name="ulogin" method="post" onsubmit="return validation()"> 
                      <center><u><h1 style="margin-left: 50px;font-size: 40px;font-family: Colonna MT;color:  brown" >User Login </h1></center></u>
...
<label style="font-size: 20px;margin-left:30px;color:  darkorange">Password:</label> <br><input type="password" class="textbox"  style="height: 32px; width:270px; " name="pass"required style="margin-left: 45px;" placeholder="Password "/><br><br>
